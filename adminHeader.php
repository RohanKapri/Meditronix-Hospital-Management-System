                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="user_action_handler.php" class="dropdown-item">Manage Users</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="all_category_doctors.php" class="dropdown-item">All Doctor's page</a>
                        </div>
                    </div>
...
<div class="nav-item dropdown">
    ...
    <div class="dropdown-menu fade-down m-0">
    <a href="all_category_services.php" class="dropdown-item">All Services </a>
    </div>
</div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="all_category_appointments.php" class="dropdown-item">Appointments Page</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="all_category_prescriptions.php" class="dropdown-item">Prescriptions Page</a>
                        </div>
                    </div>
<!-- News Dropdown -->
<div class="nav-item dropdown">
    ...
    <div class="dropdown-menu fade-down m-0">
        <a href="all_category_news.php" class="dropdown-item">News Page</a>
    </div>
</div>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Contact Queries</a>
                        <div class="dropdown-menu fade-down m-0">
                            <a href="all_category_contact_queries.php" class="dropdown-item">Contact Queries Page</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="all_category_feedback.php" class="dropdown-item">Feedback Page</a>
                        </div>
                    </div>
                    <!-- Login Button -->
