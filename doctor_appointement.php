...
<div class="container-wrapper">
    <style>
        ...
        :root {
            ...
            /* Container Background: Greyish Golden with Diamond Crystal Color */
            --container-bg-gradient: linear-gradient(135deg, #F5F5DC, #E6E6FA, #FFFAF0); /* Pale Goldenrod, Lavender, Floral White */
            --container-border-color: rgba(180, 180, 180, 0.4); /* Subtle greyish border */
        ...
        * {
        ...
        .container-wrapper {
            ...
            margin: 80px auto;
            background: var(--container-bg-gradient); /* Greyish Golden with Diamond Crystal for container */
        ...
        .slider-card {
            ...
            z-index: 5;
            background-image: url('https://cdn.pixabay.com/photo/2020/04/10/17/25/doctor-5026886_1280.jpg'); /* Placeholder image for card background */
    ...
    <div class="page-header">
        <h1><i class="fas fa-calendar-check" style="margin-right: 20px; color: #6dd5ed;"></i>Meditronix: Your Appointments Dashboard<i class="fas fa-clock" style="margin-left: 20px; color: #feb47b;"></i></h1>
        <p>Stay organized and informed with a comprehensive overview of all your scheduled healthcare appointments. This dynamic dashboard provides real-time updates, allowing you to seamlessly monitor upcoming consultations, patient details, and service information. Empowering efficient medical management, one appointment at a time.</p>
    </div>
        ...
        <div class="slider-track" id="sliderTrack">
            ...
            ?>
                    <div class="slider-card">
                        ...
                        <p><strong>Doctor Name:</strong> <?php echo htmlspecialchars($row["doctor's_name"]); ?></p>
                        ...
                        <p><strong>Status:</strong> <span style="font-weight: bold; color: <?php
                            ...
                            elseif (strtolower($row['status']) == 'pending') { $status_color = '#ffc107'; } // Orange
                        ...
                        <footer class="crud-buttons">
                            ...
                            <a href='doctor_view_appointment.php?id=<?php echo $row['id']; ?>' class='btn btn-view' target="_blank" title='View Appointment Details'>👁️ View Details</a>
            ...
            ?>
                <div class="slider-card" style="flex: 0 0 100%; text-align: center; padding: 50px; background-image: url('https://placehold.co/700x400/F8F9FA/6C757D?text=No+Appointments+Available');">
                    ...
                    <p>Currently, there are no scheduled appointments to display. All your appointments will appear here automatically.</p>
    ...
    <div id="popup-message">✨ Your Appointments, Organized ✨
        <br>
    ...
    <script>
        ...
        document.querySelectorAll('.slider-card').forEach(card => {
            card.addEventListener('click', function(event) {
                ...
                if (!event.target.closest('footer')) { // Ensure click is not on footer buttons
        ...
        // Custom Action Confirmation Modal Logic (for "View" button, if needed for confirmation)
        // For this specific request, the "View" button directly links, so this modal is more for future expansion
        ...
        // Example of how to trigger this modal if a button needed confirmation
        // document.querySelectorAll('.btn-some-action').forEach(button => {
        //     button.addEventListener('click', function(event) {
        //         event.preventDefault();
        //         actionToPerform = this.dataset.actionType; // e.g., 'view', 'edit', 'delete'
        ...
        confirmActionYes.addEventListener('click', function() {
            if (actionToPerform) {
                console.log('Confirmed action:', actionToPerform);
                // Implement logic based on actionToPerform
            }
