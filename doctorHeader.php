...
<div class="nav-item dropdown">
    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Doctor Profile</a>
    <div class="dropdown-menu fade-down m-0">
        <a href="all_update_doctor.php?id=1" class="dropdown-item">Update Doctor Profile</a>
    </div>
</div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                          <a href="doctor_appointement.php" class="btn btn-outline-primary fw-bold"> View Appointments</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                          <a href=" schedule_appointemnet.php" class="btn btn-outline-primary fw-bold">Appointments Availability</a>
...
<!-- News Dropdown -->
<div class="nav-item dropdown">
    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">News & Announcements</a>
    <div class="dropdown-menu fade-down m-0">
        <a href="Daily_news.php" class="dropdown-item">News Page</a>
    </div>
</div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="doctor_prescriptions.php" class="dropdown-item">Prescriptions Page</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="View_feedback.php" class="dropdown-item">Feedback Page</a>
                        </div>
                    </div>
                    <!-- Login Button -->
